...
|---|---|---|
| `skills/mono/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-aisearch/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-aitable/SKILL.md` | `1.0.0` | `>=1.0.15` |
...
| `skills/multi/dingtalk-doc/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-drive/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-mail/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-minutes/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-misc/SKILL.md` | `1.0.0` | `>=1.0.15` |
| `skills/multi/dingtalk-shared/SKILL.md` | `1.0.0` | `>=1.0.15` |
