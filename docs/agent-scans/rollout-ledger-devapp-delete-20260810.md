...
扫描时间：2026-08-10T10:03:33+08:00
...
- PASS: `dws devapp +delete`: `dual_validate` → `unified_active`
...
| `dws agoal obj-template list` | `unified_active` | `unified` | no |
...
| `dws aitable +base-get` | `unified_active` | `unified` | no |
| `dws aitable +base-get-primary-doc-id` | `legacy_only` | `legacy` | no |
| `dws aitable +base-list` | `unified_active` | `unified` | no |
| `dws aitable +base-schema-snapshot` | `legacy_only` | `legacy` | no |
| `dws aitable +base-search` | `unified_active` | `unified` | no |
...
| `dws aitable +list-tables` | `unified_active` | `unified` | no |
...
| `dws aitable +resolve-base` | `unified_active` | `unified` | no |
| `dws aitable +resolve-table` | `unified_active` | `unified` | no |
...
| `dws contact +lookup` | `unified_active` | `unified` | no |
| `dws contact +me` | `unified_active` | `unified` | no |
| `dws contact +org` | `unified_active` | `unified` | no |
| `dws contact +resolve-dept` | `unified_active` | `unified` | no |
| `dws contact +search-mobile` | `unified_active` | `unified` | no |
| `dws contact +search-user` | `unified_active` | `unified` | no |
| `dws contact +team` | `unified_active` | `unified` | no |
...
| `dws devapp +delete` | `unified_active` | `unified` | no |
...
| `dws todo +due-today` | `unified_active` | `unified` | no |
...
| `dws todo +related-tasks` | `unified_active` | `unified` | no |
...
| `dws wiki +resolve-space` | `unified_active` | `unified` | no |
