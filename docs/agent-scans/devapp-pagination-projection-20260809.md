...
扫描时间：2026-08-09T14:57:20+08:00
...
- 焦点测试：`TestDevAppProjectedLists(PreservePaginationEvidence|RejectInvalidPaginationEvidence)`
- 测试退出码：`0`
...
PASS
ok  	github.com/DingTalk-Real-AI/dingtalk-workspace-cli/internal/shortcut/devapp	0.254s
```
