...
| AITable: failure 缺 typed error 会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
| AITable: meta/dry_run 非法类型会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
...
| Todo: failure 缺 typed error 会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
| Todo: meta/dry_run 非法类型会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
...
| Misc: failure 缺 typed error 会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
| Misc: meta/dry_run 非法类型会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
...
| Shared: failure 缺 typed error 会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
| Shared: meta/dry_run 非法类型会被统一出口拒绝 | PASS | rc=1; payload={'ok': False, 'outcome': 'failure', 'error': {'type': 'internal', 'message': '脚本产生了非契约机器输出；请修复脚本后重试。', 'details': {'violation': 'machine_stdout_contract'}}} |
