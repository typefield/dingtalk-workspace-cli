...
REVIEWED_HIDDEN_REASONS = {
	...
	("devapp", "+version-create"): "保留隐藏：会创建应用版本并可能产生后续发布资源；当前 pending/清理和幂等证据不足。",
	("devapp", "+version-publish"): "保留隐藏：会触发线上版本发布及审批链路；需完整 pending/approval/回滚验证后再公开。",
	...
	("report", "+report-latest"): "保留隐藏：旧的最近日志聚合入口与 report inbox/outbox 规范路径重叠，展示字段和方向语义不够明确。",
