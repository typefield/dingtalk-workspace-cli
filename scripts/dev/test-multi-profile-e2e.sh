...
expect_contains "$MONO_HOME/.agents/skills/dws/SKILL.md" "dws auth login --intl"
expect_contains "$MONO_HOME/.agents/skills/dws/references/global-reference.md" "userId/userName"
expect_contains "$MONO_HOME/.agents/skills/dws/references/global-reference.md" "dws auth login --intl"
...
expect_contains "$MULTI_HOME/.agents/skills/dingtalk-shared/SKILL.md" "dws auth login --intl"
expect_contains "$MULTI_HOME/.agents/skills/dingtalk-shared/references/global-reference.md" "dws auth login --intl"
...
expect_contains "$MULTI_HOME/.agents/skills/dingtalk-misc/references/profile.md" "dws auth login --intl"
