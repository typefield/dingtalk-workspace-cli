...
> 听记产品命令见 [minutes.md](./minutes-commands.md)；跨产品检索/消息/文档能力按需加载 `dingtalk-aisearch`、`dingtalk-chat`、`dingtalk-doc`。
...
| ② 高   | 通讯录 + 组织架构  | `dws contact user search --query <姓名> --format json` → 部门/职级/上级/汇报关系                    |
