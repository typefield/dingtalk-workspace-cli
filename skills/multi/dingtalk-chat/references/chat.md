...
| `chat file upload` | 下载链接字段 | message send 的 Markdown 链接文本 |
...
| `chat file upload` / `drive download` | 下载链接 | message send 的 Markdown 链接文本（仅文字+非图片文件双发场景；常规发图/发文件用 `--msg-type file --file-path`） |
