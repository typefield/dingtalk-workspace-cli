...
> 当前开源分支以服务发现和 MCP overlay 为事实源。本文是 yulan 应用侧指令参考；若 `dws devapp --help` 或 `dws schema devapp...` 与本文冲突，以运行时输出为准。
...
详细 MCP overlay、P0 RPC 出入参契约、Agent 裁剪规则、上线验收清单和验收用例见仓库文档：
