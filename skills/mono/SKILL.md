---
name: dws
description: 管理钉钉产品能力(AI表格/AI搜问/日历/通讯录/群聊与机器人/待办/审批/考勤/日志/DING消息/开放平台文档/开放平台应用/钉钉文档/钉钉云盘/AI听记/邮箱/在线电子表格/知识库等)。当用户需要操作表格数据、管理日程会议、模糊找人/查谁负责某事项、查询通讯录、管理群聊、机器人发消息、创建待办、提交审批、查看考勤、提交日报周报（钉钉日志模版）、读写钉钉文档、上传下载云盘文件、查询听记纪要、收发邮件、读写在线电子表格(axls)、管理钉钉知识库、管理开放平台企业内部应用或应用权限时使用。
cli_version: ">=1.0.15"
---
...
| `devapp`          | 开放平台应用：企业内部应用查询/详情/创建/修改/删除、应用权限 APP/SNS 列表与申请取消、凭证/事件/版本目标链路       | [devapp.md](./references/products/devapp.md)                   |
...
- "应用" 是泛词，不默认等于开放平台应用。只有出现"开放平台应用/开发者后台应用/企业内部应用"，
  或伴随 `agentId/clientId/appKey/appSecret/customKey/应用权限/权限点/事件订阅/应用版本/发布审核`
...
用户提到"开放平台应用/开发者后台应用/企业内部应用/应用 agentId/clientId/appKey/appSecret/应用权限/权限点/事件订阅/应用版本发布/审核" → `devapp`
